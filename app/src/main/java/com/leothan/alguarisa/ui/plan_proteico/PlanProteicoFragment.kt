package com.leothan.alguarisa.ui.plan_proteico
...
class PlanProteicoFragment : Fragment() {

    private lateinit var viewModel: PlanProteicoViewModel

    override fun onCreateView(
        inflater: LayoutInflater, container: ViewGroup?,
        savedInstanceState: Bundle?
    ): View? {
        viewModel = ViewModelProvider(this).get(PlanProteicoViewModel::class.java)
        val root = inflater.inflate(R.layout.fragment_plan_proteico, container, false)

        val url = Url().direccion(Url.NombreUrl.PLAN_PROTEICO) + "/" + SharedApp.prefs.id
