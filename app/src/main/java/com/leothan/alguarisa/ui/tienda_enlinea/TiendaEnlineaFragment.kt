package com.leothan.alguarisa.ui.tienda_enlinea
...
class TiendaEnlineaFragment : Fragment() {

    private lateinit var viewModel: TiendaEnlineaViewModel

    override fun onCreateView(
        inflater: LayoutInflater, container: ViewGroup?,
        savedInstanceState: Bundle?
    ): View? {
        viewModel = ViewModelProvider(this).get(TiendaEnlineaViewModel::class.java)
        val root = inflater.inflate(R.layout.fragment_tienda_enlinea, container, false)

        val url = Url().direccion(Url.NombreUrl.TIENDA_ENLINEA) + "/" + SharedApp.prefs.id
