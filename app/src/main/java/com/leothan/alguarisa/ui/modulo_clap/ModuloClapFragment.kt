package com.leothan.alguarisa.ui.modulo_clap
...
class ModuloClapFragment : Fragment() {

    private lateinit var viewModel: ModuloClapViewModel

    override fun onCreateView(
        inflater: LayoutInflater, container: ViewGroup?,
        savedInstanceState: Bundle?
    ): View? {
        viewModel = ViewModelProvider(this).get(ModuloClapViewModel::class.java)
        val root = inflater.inflate(R.layout.fragment_modulo_clap, container, false)

        val url = Url().direccion(Url.NombreUrl.MODULO_CLAP) + "/" + SharedApp.prefs.id
