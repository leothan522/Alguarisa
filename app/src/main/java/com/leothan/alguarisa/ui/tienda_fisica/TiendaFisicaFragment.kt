package com.leothan.alguarisa.ui.tienda_fisica
...
class TiendaFisicaFragment : Fragment() {

    private lateinit var viewModel: TiendaFisicaViewModel

    override fun onCreateView(
        inflater: LayoutInflater, container: ViewGroup?,
        savedInstanceState: Bundle?
    ): View? {
        viewModel = ViewModelProvider(this).get(TiendaFisicaViewModel::class.java)
        val root = inflater.inflate(R.layout.fragment_tienda_fisica, container, false)

        val url = Url().direccion(Url.NombreUrl.TIENDA_FISICA) + "/" + SharedApp.prefs.id
